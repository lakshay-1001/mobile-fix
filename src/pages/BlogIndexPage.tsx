...
import { serviceGuides } from "../data/seoContent";
...
export default function BlogIndexPage() {
  return (
    <WebsiteLayout>
      <SEO
        title="Device Care Guides and Device Help Articles"
        description="Read practical guides about cracked screens, battery symptoms, charging problems and choosing a mobile fix shop in Dubai."
        path="/blog"
      ...
      <section className="bg-[#fffafd] px-5 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-[1120px]">
          <Breadcrumbs items={[{ name: "Home", path: "/" }, { name: "Service guides" }]} />
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#b7004f]">Helpful, practical information</p>
            <h1 className="mt-3 text-4xl font-black tracking-[-0.035em] text-[#171217] sm:text-5xl">Device care guides</h1>
            <p className="mt-5 text-lg leading-8 text-[#5a4045]">Understand common symptoms, protect your data and make a better-informed fix decision. These guides provide general information; an exact fault still requires diagnosis.</p>
          </div>
