...
const routes = [
  ...
  { path: "/shop", title: "Mobile Phones, Laptops & Accessories Shop Dubai | Azan Mobile Fix", description: "Shop mobile phones, laptops, devices and accessories at Azan Mobile Fix in Dubai. New, refurbished and pre-owned options available." },
